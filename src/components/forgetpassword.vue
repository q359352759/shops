...
<script>
	...
	import $ from "jquery"
		...
		methods:{
			...
			sendSmsCode(){
			    var reg=11&& /^((12|13|14|15|16|17|18|19)[0-9]{1}\d{8})$/;//手机号正则验证
...
<style>
	...
	#forget  input{border:none;height:0.75rem;border-bottom:1px solid #cccccc;width: 100%;display: inline-block;margin-top:0.7rem;}
	#forget .content  button{width:80%;height:1.05rem;background-color:#30abee;border-radius:0.3rem;color:white;text-align: center;font-size:0.3rem;margin-bottom:0;margin-top:0.5rem;
								letter-spacing:0.03rem;font-size:0.4rem;}
	#forget .content .verify-btn{z-index: 10;border: none;position: absolute;width:1.9rem;position: absolute;top: 96%;left: 70%;margin-top:0.7rem;color:#30abee;text-align: center;}
	...
	#forget .content #phone{padding: 0;background-image:url('../../static/img/phoneimg.png');background-repeat: no-repeat;padding-left:0.65rem;box-sizing: border-box;}
	#forget .content #payment{padding: 0;background-image:url('../../static/img/suoimg.png');background-repeat: no-repeat;padding-left:0.65rem;box-sizing: border-box;}
	#forget .content #newpayment{background-image:url('../../static/img/suoimg.png');background-repeat: no-repeat;padding-left:0.65rem;box-sizing: border-box;}
	#forget .content #yes{background-image:url('../../static/img/suoimg.png');background-repeat: no-repeat;padding-left:0.65rem;box-sizing: border-box;}
	#forget .content>div{width:100%;}
